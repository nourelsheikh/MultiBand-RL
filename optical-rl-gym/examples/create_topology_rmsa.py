...
# capacity: Gbps
# maximum_distance: km
modulations.append({'modulation': 'BPSK', 'capacity': 23., 'maximum_length': 19900})
modulations.append({'modulation': 'QPSK', 'capacity': 46., 'maximum_length': 9900})
modulations.append({'modulation': '8QAM', 'capacity': 69., 'maximum_length': 5400})
modulations.append({'modulation': '16QAM', 'capacity': 92., 'maximum_length': 2700})
modulations.append({'modulation': '32QAM', 'capacity': 115., 'maximum_length': 1300})
modulations.append({'modulation': '16QAM', 'capacity': 140., 'maximum_length': 700})
modulations.append({'modulation': '16QAM', 'capacity': 186., 'maximum_length': 100})
...
with open(f'./topologies/NSFNET_chen_eon_{k_paths}-paths_C.h5', 'wb') as f:
